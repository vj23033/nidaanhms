    ...
    return (
        <>        <div className='flex flex-col py-[40px] items-center'>
            <div className='flex flex-col items-center gap-[20px] text-center px-[20px] sm:p-0'>
                <p className='bg-[color:var(--blue-violet)] px-[15px] py-[10px] max-w-fit rounded-[100px]'>Testimonials</p>
                <h3 className='text-[length:var(--heading-h3)] font-extrabold'>Why our customers loves us</h3>
                <p className='text-[length:var(--md-text)] text-[color:var(--grey)] sm:max-w-[50%]'>We’re trusted by <span className='text-[color:var(--purple)]'>+1500</span> Hospitals in <span className='text-[color:var(--purple)]'>+6</span> States. Explain what results you’ve gained for your customers.</p>
